...
class Tabs extends BaseComponent {
    ...
    selectors = {
        ...
        contentAlt: '[data-js-tabs-content-alt]',
    }
    ...
    constructor(rootElement) {
        ...
        this.contentAltElements = this.rootElement.querySelectorAll(this.selectors.contentAlt)
    ...
    updateUI() {
        ...
        this.contentAltElements.forEach((contentAltElement, index) => {
            const isActive = index === activeTabIndex

            contentAltElement.classList.toggle(this.stateClasses.isActive, isActive)
        })
    }
    ...
    bindEvents() {
        this.buttonElements.forEach((buttonElement, index) => {
            buttonElement.addEventListener('click', () => this.activateTab(index))
        })
